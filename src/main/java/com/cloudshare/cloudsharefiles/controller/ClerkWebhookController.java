...
public class ClerkWebhookController {
    ...
    public void handleUserCreated(JsonNode data) {
        ...
        ProfileDocumentDto newProfile = ProfileDocumentDto.builder()
                .clerkId(clerkId)
                .email(email)
                .firstname(firstname)
                .lastname(lastname)
        ...
        userCreditsService.createIntailCredits(clerkId);
    }
    ...
    public void handleUserUpdated(JsonNode data) {
        ...
        ProfileDocumentDto updateProfile = ProfileDocumentDto.builder()
                .clerkId(clerkId)
                .email(email)
                .firstname(firstname)
                .lastname(lastname)
        ...
        ProfileDocumentDto result = profileService.updateProfile(updateProfile);
        if (result == null) {
    ...
    public void handleUserDeleted(JsonNode data) {
        String clearkId = data.path("id").asText();
        profileService.deleteProfile(clearkId);
    }

    private boolean verifyWebhookSignature(String svixId, String svixTimestamp, String svixSignature, String payload) {
        // TODO: implement actual Svix signature verification
        return true;
    }
}
